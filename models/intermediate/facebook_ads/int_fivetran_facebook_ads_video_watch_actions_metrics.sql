...
with p25_report as (
	select * 
	from {{ ref('stg_fivetran_facebooks_ads__ad_performance_v_1_video_p_25_watched_actions') }}

),
p50_report as (
	select * 
	from {{ ref('stg_fivetran_facebooks_ads__ad_performance_v_1_video_p_50_watched_actions') }}

),
p75_report as (
	select * 
	from {{ ref('stg_fivetran_facebooks_ads__ad_performance_v_1_video_p_75_watched_actions') }}

),
p95_report as (
	select * 
	from {{ ref('stg_fivetran_facebooks_ads__ad_performance_v_1_video_p_95_watched_actions') }}

),
p100_report as (
	select * 
	from {{ ref('stg_fivetran_facebooks_ads__ad_performance_v_1_video_p_100_watched_actions') }}

),
_30_sec_report as (
	select * 
	from {{ ref('stg_fivetran_facebooks_ads__ad_performance_v_1_video_30_sec_watched_actions') }}

),
avg_time_report as (
	select * 
	from {{ ref('stg_fivetran_facebooks_ads__ad_performance_v_1_video_avg_time_watched_actions') }}

),
play_report as (
	select * 
	from {{ ref('stg_fivetran_facebooks_ads__ad_performance_v_1_video_play_actions') }}
...
metrics_join as (
	...
	on p25_metrics.source_relation = p50_metrics.source_relation
	...
	on p25_metrics.source_relation = p75_metrics.source_relation
	...
	on p25_metrics.source_relation = p95_metrics.source_relation
	...
	on p25_metrics.source_relation = p100_metrics.source_relation
	...
	on p25_metrics.source_relation = _30_sec_metrics.source_relation
	...
	on p25_metrics.source_relation = play_metrics.source_relation
	...
	on p25_metrics.source_relation = avg_time_metrics.source_relation
