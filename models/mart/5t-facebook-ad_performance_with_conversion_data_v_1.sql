...
WITH
  ...
  actions_combined AS (
  SELECT
    COALESCE(A.fivetran_id, B.fivetran_id, C.fivetran_id, D.fivetran_id, E.fivetran_id, F.fivetran_id, G.fivetran_id, H.fivetran_id, I.fivetran_id, J.fivetran_id, K.fivetran_id, L.fivetran_id) fivetran_id,
    COALESCE(A.day, B.day, C.day, D.day, E.day, F.day, G.day, H.day, I.day, J.day, K.day, L.day) day,
    COALESCE(A.ad_id, B.ad_id, C.ad_id, D.ad_id, E.ad_id, F.ad_id, G.ad_id, H.ad_id, I.ad_id, J.ad_id, K.ad_id, L.ad_id) ad_id,
  ...
  ON
    A.day=L.day
    AND A.ad_id=L.ad_id
    AND A.action_type=L.action_type
    AND A.fivetran_id=L.fivetran_id
    AND A.idx=L.idx
  GROUP BY 1,2,3),
...
SELECT
    ...
    SAFE_CAST(NULL AS INT64) video_15_sec_watched_actions,
    ...
    /* Below SAFE_CASTs should be for cost and revenue - may be named differently in dpl_project_id_raw_main*/
